...
./.venv/bin/python -u \
  sam3_lightweight_tinyvit_stage3_distill_exp/p3_all_r16/convert_all_lora_rank.py \
  ...
  --output sam3_lightweight_tinyvit_stage3_distill_exp/weights/p3_all_r16_init.pt \
  --rank 16 \
  --alpha 32 \
  --stages 1 2 3
