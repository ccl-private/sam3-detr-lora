...
./.venv/bin/python -u \
  sam3_lightweight_stage3_distill_exp/train_p0.py \
  ...
  --checkpoint sam3_lightweight_stage3_exp/input/efficientsam3_efficientvit_stage3.pt \
  --save sam3_lightweight_stage3_distill_exp/weights/p0_r8.pt \
  --epochs 10 \
  --batch-size 4 \
  --num-workers 8 \
  --lora-lr 5e-5 \
