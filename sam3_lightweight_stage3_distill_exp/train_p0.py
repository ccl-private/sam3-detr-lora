...
class P0DistillModule(L.LightningModule):
    def __init__(
        ...
        missing = [key for key in missing if "parametrizations" in key or key.startswith(("dot_prod_scoring.", "segmentation_head."))]
    ...
    def save_lora_checkpoint(self, path: Path) -> None:
        meta = {
            **self.student_source_meta,
            "experiment": "P0-R8 final-output distillation",
